          ...
          <div class="col-12">
            <div class="card recent-sales overflow-auto">
              <div class="card-body">
                ...
                <form class="row g-3" method="POST" action="{{ '/Retur/'.$pengadaan->id.'/'.$penerimaan->id }}" >
                    @csrf
                <table class="table">
                    <thead>
                      <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                    <div class="form-floating">
                                        <input type="number" class="form-control" id="jumlah" placeholder="jumlah" name="retur[]" value="0" max="{{ $item->jumlah }}">
                            ...
                            <td>
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="alasan" placeholder="alasan" name="alasan[]" value="-">
                                    <label for="floatingName">Alasan</label>
                                  </div>
                            {{-- <a href="{{ '/Pengadaan/create/'.$item->id }}" class="btn btn-success btn-sm">Pesan</a> --}}
                        </td>
                        </tr>
                ...
                <div class="d-flex justify-content-end" style="width: 100%">
                    <a style="margin-right: 20px" href="/vendor" class="btn btn-success plus-icon d-flex align-items-center justify-content-center">
                        Kembali
                    </a>
